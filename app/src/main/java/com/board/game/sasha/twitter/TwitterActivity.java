package com.board.game.sasha.twitter;
...
public class TwitterActivity extends Activity implements OnClickListener {
    ...
    private class LoginTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pd = new ProgressDialog(TwitterActivity.this);
        ...
        protected void onPostExecute(String result) {
			...
			if(pd!=null && pd.isShowing())
				pd.dismiss();
			final Intent intent = new Intent(TwitterActivity.this, TwitterLogin.class);
			intent.putExtra(TwitterLogin.EXTRA_URL, requestToken.getAuthenticationURL());
    ...
    private class LoginResultParseTask extends AsyncTask<Intent, Void, String> {
        ...
        protected String doInBackground(Intent... data) {
            ...
            String verifier = data[0].getExtras().getString(oAuthVerifier);
            try {
                AccessToken accessToken = twitter.getOAuthAccessToken(requestToken, verifier);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            new LoginResultParseTask().execute(data);
        }
    ...
    class updateTwitterStatus extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... args) {
            ...
            try {
                ...
                InputStream is = getResources().openRawResource(R.drawable.btn_blue_matte);
